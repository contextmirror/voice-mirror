...
|------|-------------|--------|--------|
| 1 | Closed tab history + Ctrl+Shift+T | ✅ Done | `37fa88d2`, `d6abc84c` |
| 2 | Mouse wheel scroll on tab bar | ✅ Done | `ea40f80e` |
| 3 | Back/forward navigation (Alt+Left/Right) | ✅ Done | `60984973` |
| 4 | Ctrl+hover definition underline | ✅ Done | `b35275db` |
| 5 | Ctrl+PageUp/PageDown tab cycling | ✅ Done | `db542e62` |
| 6 | Tab drag → split zones | ✅ Done | `fec26492` |
| 7 | Update UX-AUDIT.md + IDE-GAPS.md | ✅ Done | `a918e699` |
| 8 | Full verification | ✅ Done | 5172 tests pass, Rust clean |
